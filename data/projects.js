...
const projectList = [
  ...
  {
    id: 'industrial-maintenance-automation',
    layoutType: 'industrialAutomation',
    number: 'PROJECT 04',
    title: '산업 장비 제어 및 유지보수 자동화',
    period: '2023.06 ~ 2023.10',
    anchorId: 'project-industrial-automation',
    bannerSubtitle: '산업 장비 제어 및 유지보수 자동화',
    tags: ['산업용 통신', '유지보수', '자동화', '장비 연동'],
    summary: [
      '기존 설비 환경의 유지보수 및 운영 문제 개선',
      '고객사 설정 가능한 운영자 중심 UI 구성',
      '산업용 프로토콜 기반 직접 통신 구조 구현',
      '컨트롤러 의존성 감소 및 유지보수 비용 절감',
      '반복 테스트 및 상태 모니터링 자동화'
    ],

    detail: {
      projectName: '산업 장비 제어 및 유지보수 자동화',
      ...
      informationRows: [
...

        {
          ...
          label: '문제 상황',
          lines: [
            '기존 산업 장비 환경에서는 설비 내부 PC 또는 특정 프로그램에서만 제어 및 상태 확인 가능',
            'CS 유지보수 출장 필수',
            '전용 중계기(컨트롤러) 기반 구조로 인한 제조사 의존성 존재'
          ]
        },

        {
          ...
          label: '해결 방향',
          lines: [
            '고객사 설정 가능한 운영자 중심 UI 설계',
            '반복 테스트 및 상태 모니터링 자동화',
            '산업용 통신 구조 분석 기반 직접 통신 구현',
            '컨트롤러 의존성 감소 및 유지보수 최소화'
          ]
        },

        {
          ...
          lines: [
            '산업용 통신 및 제어 프로그램 개발',
            '유지보수 구조 개선 및 자동화 기능 구현',
            '장비 상태 모니터링 및 테스트 기능 개발'
          ]
        }
      ]
    },

    industrialAutomationContent: {
      problemLines: [
        '기존 설비 환경에서는 특정 프로그램 또는 내부 PC 환경에서만 상태 확인 및 제어 가능',
        '유지보수 및 설정 변경 시 현장 방문 필요',
        '특정 제조사 컨트롤러 종속 구조로 인해 시스템 확장 제약 발생'
      ],

      solutionIntro: '운영자 중심 UI 및 직접 통신 기반 구조 구현',

      solutionSteps: [
        '고객사가 직접 설정 가능한 UI 제공',
        '실시간 상태 확인 및 데이터 수집 가능',
        '산업용 프로토콜 기반 직접 통신 구현',
        '반복 테스트 및 상태 모니터링 자동화',
        '유지보수 및 운영 비용 절감'
      ],
      ...
      implementationItems: [
        {
          title: '운영자 중심 UI',
          details: [
            '설정 파일 수정 없이 프로그램 내부에서 설정 가능',
            '운영 편의성 향상 및 현장 대응 시간 단축'
          ]
        },

        {
          title: '산업용 통신 프로토콜 연동',
          details: [
            '장비 간 통신 구조 분석',
            '제어 명령 및 상태 데이터 처리',
            '직접 통신 기반 제어 기능 구현'
...

        {
          title: '유지보수 가능한 구조',
          details: [
            'Delphi, C, C++, C#, Python 기반 수정 및 기능 확장 가능',
            '라이브러리 종속성 최소화',
            '결과물 소유권 이전 가능'
          ]
        }
